...
const defaultTableData = [
    ...
    },
    {
        ...
        isertNode: '当本轮出现表中没有的新角色时，应插入/当此表为空时，必须从上文寻找已知角色插入，角色名不能为空', updateNode: "当角色的身体出现持久性变化时，例如伤痕/当角色有新的爱好，职业，喜欢的事物时/当角色更换住所时/当角色提到重要信息时", deleteNode: ""
    },
    {
        tableName: '角色与<user>社交表格', tableIndex: 2, columns: ['角色名', '对<user>关系', '对<user>态度', '对<user>好感'], note: '思考如果有角色和<user>互动，应什么态度',
        isertNode: '当本轮出现表中没有的新角色时，应插入/当此表为空时，必须从上文寻找已知角色插入，角色名不能为空', updateNode: "当角色和<user>的交互不再符合原有的记录时/当角色和<user>的关系改变时", deleteNode: ""
    },
    {
